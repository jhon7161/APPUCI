    ...
    <tbody>
      {form.dosisUnica?.map((dosis, idx) => (
        <tr key={idx}>
          ...
          <td>
            <button className="btn-eliminar" type="button" onClick={() => eliminarDosis(idx)}>❌</button>
          </td>
        </tr>
      ))}
    </tbody>
